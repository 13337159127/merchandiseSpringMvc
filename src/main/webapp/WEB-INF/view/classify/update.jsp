	...
	<div class="wrapper">
		...
		<div class="main-panel">
			...
			<div class="content">
				...
				<form action="/merchandisemvc/UpdateClassify.kexin" method="get">				
				<table class="table table-striped">
				<c:forEach items="${list}" var="category">
                <tr>
                  <th width="30%">分类Id</th>
                  <td width="70%"><input type="text" name="categoryId" value="${category.categoryId}"></td>
                </tr>
                <tr>
                  <th width="30%">商品分类</th>
                  <td width="70%"><input type="text" name="category" value="${category.category}"></td>
                </tr>
                </c:forEach>
				</table>
